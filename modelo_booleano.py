...
# Função criar os tokens/lemas e remover stopwords do documento
...
#Função para lematizar os termos da consulta
...
# Função para gerar o índice invertido no formato lema: documentos
...
#Função para recuperar os documentos em que um termo aparece
...
#Função para transformar uma consulta para o formato pós-fixo
...
# Funções para resolver uma expressão em notação pós-fixa
...
#Função para salvar o indice invertido criado em um arquivo txt
...
#Função para salvar os documentos válidos em um arquivo txt
...
#Função com os passos para processar a consulta
